/**
 * Fantasticauth Tenant API types
...
// Tenant-friendly aliases for admin-shaped API payloads.
export type TenantUserResponse = AdminUserResponse;
export type TenantSessionListResponse = AdminSessionListResponse;
export type TenantOrganizationResponse = AdminOrganizationResponse;
export type TenantOrganizationMemberResponse = AdminOrganizationMemberResponse;
