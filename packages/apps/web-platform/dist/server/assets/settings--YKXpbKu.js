...
import { Settings, Shield, Mail, CreditCard, Bell, Webhook, Key, Lock, BarChart3, Server, Search, X, ChevronRight, AlertTriangle, CheckCircle } from "lucide-react";
import { c as cn$1, P as PageHeader, a as Badge, B as Button, t as toast } from "./router-BqFKwE1w.js";
...
import { g as getUiConfig } from "./internal-api-DaRn9LSO.js";
...
function SettingsPage() {
  ...
  const renderSetting = (setting) => {
    ...
    switch (setting.type) {
      ...
      case "slider":
        const min = "min" in setting && typeof setting.min === "number" ? setting.min : 0;
        const max = "max" in setting && typeof setting.max === "number" ? setting.max : 100;
        return /* @__PURE__ */ jsx("div", { className: "w-48", children: /* @__PURE__ */ jsx(Slider, { value: [value], onValueChange: ([v]) => updateSetting(setting.id, v), min, max, showValue: true }) });
      default:
        return null;
    }
  };
  ...
  return /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative", children: [
      ...
      searchQuery && /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setSearchQuery(""), className: "absolute right-3 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx(X, { className: "h-4 w-4 text-muted-foreground" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-4 gap-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "lg:col-span-1 space-y-2", children: [
        ...
        filteredCategories.map((category) => {
          ...
          return /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setActiveCategory(category.id), className: cn("w-full flex items-center gap-3 p-3 rounded-lg text-left transition-colors", isActive ? "bg-primary/10 text-primary" : "hover:bg-muted"), children: [
