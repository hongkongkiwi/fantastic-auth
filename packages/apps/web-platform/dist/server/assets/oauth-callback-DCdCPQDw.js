...
import { H as HostedLayout, u as useHostedConfig, e as hostedOAuthCallback } from "./HostedLayout-BdDuyvHy.js";
...
function HostedOAuthCallbackPage() {
  return /* @__PURE__ */ jsx(HostedLayout, { searchParams: new URLSearchParams(window.location.search), children: /* @__PURE__ */ jsx(OAuthCallbackContent, {}) });
}
