...
import { H as HostedLayout, u as useHostedConfig, f as hostedRequestPasswordReset } from "./HostedLayout-BdDuyvHy.js";
...
function HostedForgotPasswordPage() {
  return /* @__PURE__ */ jsx(HostedLayout, { searchParams: new URLSearchParams(window.location.search), children: /* @__PURE__ */ jsx(ForgotPasswordContent, {}) });
}
