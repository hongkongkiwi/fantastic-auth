"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; } var _class;// src/types/plugins.types.ts
...
var PluginManager = (_class = class {
  ...
  __init() {this.onBeforeDataOut = []}
  __init2() {this.shouldSendToLogger = []}
  __init3() {this.onMetadataCalled = []}
  __init4() {this.onBeforeMessageOut = []}
  constructor(plugins) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);_class.prototype.__init3.call(this);_class.prototype.__init4.call(this);
    this.idToPlugin = {};
...
var LogLayer = class _LogLayer {
  ...
  constructor({
    ...
    this.loggerType = _optionalChain([logger, 'optionalAccess', _ => _.type]) || "other" /* OTHER */;
    this.context = {};
    this.hasContext = false;
    this._config = {
      enabled: _nullishCoalesce(enabled, () => ( true)),
      consoleDebug: _nullishCoalesce(consoleDebug, () => ( false)),
      error: error || {},
      context: context || {},
      metadata: metadata || {},
      prefix: prefix || "",
  ...
  errorOnly(error, opts) {
    ...
    const formatLogConf = {
      logLevel: _optionalChain([opts, 'optionalAccess', _2 => _2.logLevel]) || "error" /* error */,
      data: {
    ...
    if ((errConfig.copyMsgOnOnlyError && _optionalChain([opts, 'optionalAccess', _3 => _3.copyMsg]) !== false || _optionalChain([opts, 'optionalAccess', _4 => _4.copyMsg]) === true) && error.message) {
...
exports.LogLayer = LogLayer; exports.LogLevel = LogLevel; exports.LoggerType = LoggerType; exports.MockLogLayer = MockLogLayer; exports.PluginCallbackType = PluginCallbackType;
