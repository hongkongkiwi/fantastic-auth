...
export const env = createEnv({
  ...
  client: {
    ...
    VITE_FEATURE_USER_SECURITY: z.enum(['true', 'false']).optional().default('true'),
    VITE_FEATURE_USER_DEVICES: z.enum(['true', 'false']).optional().default('true'),
    VITE_FEATURE_USER_SESSIONS: z.enum(['true', 'false']).optional().default('true'),
    VITE_FEATURE_USER_PRIVACY: z.enum(['true', 'false']).optional().default('true'),
    VITE_FEATURE_USER_ACTIVITY: z.enum(['true', 'false']).optional().default('true'),
