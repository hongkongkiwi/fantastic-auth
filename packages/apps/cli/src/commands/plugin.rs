//! Plugin management commands for the Fantastic Auth CLI
...
description = "A custom Fantastic Auth plugin"

[lib]
crate-type = ["cdylib", "rlib"]

[dependencies]
fantasticauth-core = {{ path = "../../../core/rust" }}
async-trait = "0.1"
...
//!
//! {}
//! This is a {} plugin for Fantastic Auth.

use async_trait::async_trait;
use serde::{{Deserialize, Serialize}};
use std::collections::HashMap;
use fantasticauth_core::plugin::types::{{
...
use fantasticauth_core::models::user::User;
...
2. Copy to your plugins directory:
   ```bash
   cp target/release/lib{}.so /opt/fantasticauth/plugins/{}/
   ```

3. Configure in Fantastic Auth:
   ```yaml
   plugins:
     - name: "{}"
       enabled: true
