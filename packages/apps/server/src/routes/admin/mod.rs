...
/// Canonical admin route mounts.
pub const MOUNT_DASHBOARD: &str = "/dashboard";
pub const MOUNT_ORGANIZATIONS: &str = "/organizations";
pub const MOUNT_AUDIT_LOGS: &str = "/audit-logs";
...
pub fn routes() -> Router<AppState> {
    Router::new()
        // Dashboard & Analytics
        .nest(MOUNT_DASHBOARD, dashboard::routes())
        .merge(analytics::routes())
        // User & Organization Management
        .merge(users::routes())
        .nest(MOUNT_ORGANIZATIONS, organizations::routes())
        .merge(groups::routes())
        ...
        // Monitoring & Logging
        .nest(MOUNT_AUDIT_LOGS, audit_logs::routes())
