# Fantastic Auth Server Integration Tests

This directory contains comprehensive integration tests for the Fantastic Auth authentication server.
...
```
TEST_DATABASE_URL=postgres://fantasticauth:fantasticauth@localhost:5432/fantasticauth_test
```
...
createdb fantasticauth_test

# Or use the full URL format
export TEST_DATABASE_URL="postgres://user:password@localhost:5432/fantasticauth_test"
```
...
|----------|-------------|---------|
| `TEST_DATABASE_URL` | PostgreSQL connection string | `postgres://fantasticauth:fantasticauth@localhost:5432/fantasticauth_test` |
...
export TEST_DATABASE_URL="postgres://user:password@host:5432/fantasticauth_test"
```
