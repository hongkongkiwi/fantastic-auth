...
import {
  ArrowLeft, Mail, Shield, Smartphone, Key, Calendar,
  Building2, MapPin, Globe, Edit2, Ban, CheckCircle,
  Trash2, UserCog, Copy, Check
} from 'lucide-react'
                  ...
                  <div key={membership.organizationId} className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Joined {formatDate(membership.joinedAt, 'short')}
                        </p>
                      </div>
                    </div>
