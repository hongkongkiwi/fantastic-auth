...
import { B as Button, m as useAuth } from "./router-BDwxh4pl.js";
...
import { S as SocialLoginButtons } from "./SocialLoginButtons-DfUR73X7.js";
    ...
    /* @__PURE__ */ jsxs(motion.div, { initial: prefersReducedMotion ? false : {
      ...
      /* @__PURE__ */ jsxs(Card, { className: "shadow-elevated", children: [
        ...
        /* @__PURE__ */ jsxs(CardContent, { children: [
          /* @__PURE__ */ jsxs(Tabs, { value: loginMethod, onValueChange: (v) => setLoginMethod(v), className: "mb-6", children: [
            ...
            /* @__PURE__ */ jsxs(TabsContent, { value: "password", className: "mt-4", children: [
              ...
              /* @__PURE__ */ jsx(motion.div, { initial: prefersReducedMotion ? false : {
                ...
                delay: 0.7
              }, className: "mt-6", children: /* @__PURE__ */ jsx(SocialLoginButtons, { onGoogleClick: () => handleOAuthLogin("google"), onGitHubClick: () => handleOAuthLogin("github"), onAppleClick: () => handleOAuthLogin("apple"), isLoading: !!oauthLoading }) })
            ] }),
          ...
          /* @__PURE__ */ jsxs(motion.div, { initial: prefersReducedMotion ? false : {
            ...
            delay: 0.8
          }, className: "mt-6 p-4 rounded-lg bg-muted/50 border border-dashed", children: [
            /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground text-center mb-2", children: "Demo Credentials" }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-2 text-sm", children: [
              /* @__PURE__ */ jsx(Badge, { variant: "secondary", children: "admin@vault.local" }),
