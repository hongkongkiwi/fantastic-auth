...
import { u as useHostedSearchParams, H as HostedLayout, a as useHostedConfig, j as hostedListOrganizations, k as hostedSwitchOrganization } from "./HostedLayout-Dne6B-Jo.js";
import "sonner";
import "../server.js";
...
function HostedOrganizationSwitchPage() {
  ...
  return /* @__PURE__ */ jsx(HostedLayout, { searchParams: new URLSearchParams(window.location.search), children: /* @__PURE__ */ jsx(OrganizationSwitchContent, { searchParams }) });
}
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "shadow-elevated", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      ...
      isLoading ? /* @__PURE__ */ jsxs("div", { className: "py-8 text-center", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-2", children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "popLayout", children: organizations.map((org, index) => /* @__PURE__ */ jsx(motion.div, { initial: prefersReducedMotion ? false : {
        ...
        }, children: /* @__PURE__ */ jsxs("button", { onClick: () => handleSwitch(org.id), disabled: switchingOrgId === org.id, className: `w-full flex items-center gap-4 p-4 rounded-lg border transition-all text-left ${organizationId === org.id ? "border-primary bg-primary/5" : "border-border hover:border-primary/50 hover:bg-muted/50"}`, children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              org.role === "owner" && /* @__PURE__ */ jsx(Crown, { className: "h-4 w-4 text-amber-500 flex-shrink-0", title: "Owner" })
            ] }),
      ...
      !isLoading && organizations.length > 0 && /* @__PURE__ */ jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxs("button", { onClick: () => handleSwitch("personal"), disabled: switchingOrgId === "personal", className: "inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors", children: [
