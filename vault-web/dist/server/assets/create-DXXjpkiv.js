...
import { u as useHostedSearchParams, H as HostedLayout, a as useHostedConfig, l as hostedCreateOrganization } from "./HostedLayout-Dne6B-Jo.js";
import "sonner";
import "../server.js";
...
function HostedOrganizationCreatePage() {
  ...
  return /* @__PURE__ */ jsx(HostedLayout, { searchParams: new URLSearchParams(window.location.search), children: /* @__PURE__ */ jsx(OrganizationCreateContent, { searchParams }) });
}
