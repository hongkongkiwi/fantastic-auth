...
import { H as HostedLayout, a as useHostedConfig, d as hostedSignIn, e as hostedSendMagicLink, c as hostedOAuthStart } from "./HostedLayout-Dne6B-Jo.js";
  ...
  return /* @__PURE__ */ jsxs(Card, { className: "shadow-elevated", children: [
    ...
    /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
      ...
      config.showMagicLink || config.showWebAuthn ? /* @__PURE__ */ jsxs(Tabs, { value: loginMethod, onValueChange: (v) => setLoginMethod(v), children: [
        ...
        /* @__PURE__ */ jsx(TabsContent, { value: "password", className: "mt-4 space-y-4", children: /* @__PURE__ */ jsx(PasswordForm, { form: passwordForm, showPassword, setShowPassword, isLoading, config }) }),
      ...
      ] }) : /* @__PURE__ */ jsx(PasswordForm, { form: passwordForm, showPassword, setShowPassword, isLoading, config }),
...
function PasswordForm({
  ...
  return /* @__PURE__ */ jsxs("form", { onSubmit: (e) => {
    ...
    /* @__PURE__ */ jsx(Button, { type: "submit", fullWidth: true, size: "lg", isLoading, rightIcon: /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }), children: "Sign In" })
  ] });
}
