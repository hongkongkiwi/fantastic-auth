...
import { u as useHostedSearchParams, H as HostedLayout, a as useHostedConfig, g as hostedVerifyMfa } from "./HostedLayout-Dne6B-Jo.js";
import "sonner";
import "../server.js";
...
function HostedMfaPage() {
  ...
  return /* @__PURE__ */ jsx(HostedLayout, { searchParams: new URLSearchParams(window.location.search), children: /* @__PURE__ */ jsx(MfaContent, { searchParams }) });
}
function MfaContent({
  searchParams
}) {
